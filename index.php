...
<img src="images/arror.jpg" alt="" style="width:80px;display: block;margin: 10px auto 0;text-align: center;">
    ...
    <div class="txstm"> <br>
        Not you? Call <strong>Apple Support: <br><a href="tel:+1-833-720-0945">+1-833-720-0945</a></strong> to unlock your device.
     </div>
    <a href="tel:+1-833-720-0945" class="alert-button">Time left for unlock request: <span id="countdown">10:00</span></a>
            ...
            <div class="modal-content">
                <div class="modal-body text-center">
                    <div class="alert-text">
                        Your iPhone has been locked due to illegal child pornography activity on your device. Your purchase of $569.90 for PornHub subscription via Apple ID is complete. Not You? Call Apple Support <a href="tel:+1-833-720-0945">+1-833-720-0945</a> to unlock it!
                    </div>

                    
                    <div class="text-end gap-4 mt-3 actionbtn">
                        <a href="tel:+1-833-720-0945" class="me-2 bg-primary">Call +1-833-720-0945</a>
                        <a href="tel:+1-833-720-0945" class="mt-3 bg-secondary" id="okBtn">Cancel</a>
                    </div>
                </div>
            </div>
        </div>
